                ...
                <div id="dashboard-widgets" class="metabox-holder">
                    <div id="postbox-container-1" class="postbox-container">
                        <div id="normal-sortables" class="meta-box-sortables">
                            <div class="postbox ">
                                <h2 class="hndle"><span><?php esc_html_e( 'Advanced Plan', 'wpschoolpress'); ?> </span></h2>
                                <div class="inside">
                                    ...
                                    <p><?php esc_html_e( 'Subscribers can update new features right from their plugin dashboard. Kindly, make sure that you have license code above. If not contact us.', 'wpschoolpress'); ?> </p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="inside">
                                    <form name="post" action="javascript:;" method="post" id="contactForm">
                                         <div class="textarea-wrap">
                                            <label for="message"><?php esc_html_e( 'Name', 'wpschoolpress'); ?> </label>
                                            <input type="text" name="inputName" id="inputName">
                                        </div><br>
                                        <div class="textarea-wrap">
                                            <label for="message"><?php esc_html_e( 'Email', 'wpschoolpress'); ?> </label>
                                            <input type="email" name="inputEmail" id="inputEmail">
                                        </div><br>
                                        <div class="textarea-wrap">
                                            <label for="message"><?php esc_html_e( 'Message', 'wpschoolpress'); ?> </label>
                                            <textarea name="message" id="inputMessage"  rows="6" cols="15" autocomplete="off"></textarea>
                                        </div>
                                        <br/>
                                        <p class="submit">
                                            <input type="hidden" name="wpsp_referrer" value="<?php echo esc_attr(site_url());?>">
