		...
		<div class="wpsp-col-xs-12">
			<div class="wpsp-card">
				<div class="wpsp-card-head">
					...
					<!-- <h3 class="wpsp-card-title"><?php //echo isset( $_GET['id'] ) ? apply_filters( 'wpsp_class_main_heading_update', esc_html__( 'Update Class Information', 'wpschoolpress' )) : apply_filters( 'wpsp_class_main_heading_add', esc_html__( 'Add Class Information', 'wpschoolpress' ));; 
														?></h3> -->
				</div>
					...
					<div class="wpsp-row">
						...
						<div class="wpsp-col-md-4 wpsp-col-sm-4 wpsp-col-xs-12">
							<div class="wpsp-form-group">
								...
								<input data-is_required="<?php echo esc_attr($is_required); ?>" type="text" pattern="[0-9]*" min=0 class="wpsp-form-control" name="Number" value="<?php echo esc_attr($classnumber); ?>">
