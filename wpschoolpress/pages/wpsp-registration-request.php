                    ...
                    <div class="subject-head">
                        ...
                        <table id="request_table" class="wpsp-table" cellspacing="0" width="100%" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="sort"><?php esc_html_e( 'Class type', 'wpschoolpress' ); ?> </th>
                        ...
                        <tbody>
                            ...
                            foreach($students as $stinfo){  
                                $cname = '';
                                if(!empty($stinfo->t_cid)){ 
                                    $cname = $wpdb->get_var( $wpdb->prepare("SELECT c_name FROM $class_table WHERE cid = %d",$stinfo->t_cid));
                                }
                                ?>
                                <tr <?php if($stinfo->t_active == 0) {echo "style='background-color:#fcdddd'";}?>>
                                    ...
                                    <td><?php echo (!empty($cname) ? $cname : ''); ?></td>
